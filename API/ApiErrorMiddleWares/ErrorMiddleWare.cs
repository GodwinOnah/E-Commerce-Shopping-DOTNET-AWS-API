        ...
        public async Task InvokeAsync(HttpContext httpContext) {
            ...
            try {
                ...
                var response = _env.IsDevelopment()
                    ? new ApiErrorExceptions((int)HttpStatusCode.InternalServerError, e.Message, e.StackTrace.ToString())
                    : new ApiErrorExceptions((int)HttpStatusCode.InternalServerError);
